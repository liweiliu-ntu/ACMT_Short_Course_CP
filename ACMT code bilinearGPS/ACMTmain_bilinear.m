...
% plot(state2(:,33),state2(:,34),'linewidth',1.0)
% title('q-Q');
% xlabel('q');
% ylabel('Q');
% 
for i=1:length(state2)
    f1(i)=norm(state2(i,20:25))-Qy;
end
f1=f1';
% figure(2)
% axes('FontSize',14,'FontName','TimesNewRoman');
% plot(state2(:,3),state2(:,34),'linewidth',1.0)
% title('q-Q');
% xlabel('q');
% ylabel('Q');
% 
% figure(3)
% axes('FontSize',14,'FontName','TimesNewRoman');
% plot(state2(:,1),state2(:,33),'linewidth',1.0)
% title('q-Q');
% xlabel('q');
% ylabel('Q');
% 
% figure(4)
% axes('FontSize',14,'FontName','TimesNewRoman');
% plot(state2(:,1),state2(:,34),'linewidth',1.0)
% title('q-Q');
% xlabel('q');
% ylabel('Q');
